 ...
 * PUT     /api/labels/:id          ->  upsert
 * PATCH   /api/labels/:id          ->  patch
...
// Upserts the given Label in the DB at the specified ID
export function upsert(req, res) {
  if(req.body._id) {
    delete req.body._id;
  }
  return Label.findOneAndUpdate({_id: req.params.id}, req.body, {upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
